...
public class BancoOccidenteHome {
    ...
    public static final Target BTN_ADMINISTRACION = Target.the("Menu desplegable de Administración").located(By.xpath("//span[contains(text(),'Administración')]"));
    public static final Target BTN_CONFIGURACION_AUTORIZACIONES = Target.the("Botón para seleccionar configutración de autorizaciones").located(By.xpath("//a[contains(text(),'Configuración de Autorizaciones ')]"));
